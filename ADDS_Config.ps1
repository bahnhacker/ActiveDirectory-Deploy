...
##
## script can be ran in its entirety once the Password Policy has been defined in "Fine-Grained Password Policies, PSO"
## script will prompt for all other variables required
##
##
...
## AD Asset Report######################################################################################################
$ADAssetReportzip = "$select_path\New-ADAssetReportGUI.zip"
$ADAssetReportunzip = "$Domain_Files\ADAssetReport"
Add-Type -assembly "system.io.compression.filesystem"
[io.compression.zipfile]::ExtractToDirectory($ADAssetReportzip, $ADAssetReportunzip)
Start-Sleep -Seconds 15
Start-Process "$ADAssetReportunzip\AD Asset Report GUI.exe"
